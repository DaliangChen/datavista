...
- 1. Supervised learning
  - 1.1. Linear Models
    - [1.1.1. Ordinary Least Squares](scikit-learn/ordinary-least-squares.md)
    - [1.1.2. Ridge regression and classification](scikit-learn/ridge-regression-and-classification.md)
    - [1.1.3. Lasso](scikit-learn/lasso.md)
    - [1.1.4. Multi-task Lasso](scikit-learn/multi-task-lasso.md)
    - [1.1.5. Elastic-Net](scikit-learn/elastic-net.md)
    - [1.1.6. Multi-task Elastic-Net](scikit-learn/multi-task-elastic-net.md)
    - [1.1.7. Least Angle Regression](scikit-learn/least-angle-regression.md)
    - [1.1.8. LARS Lasso](scikit-learn/lars-lasso.md)
    - [1.1.9. Orthogonal Matching Pursuit (OMP)](scikit-learn/orthogonal-matching-pursuit-omp.md)
    - [1.1.10. Bayesian Regression](scikit-learn/bayesian-regression.md)
    - [1.1.11. Logistic regression](scikit-learn/logistic-regression.md)
    - [1.1.12. Generalized Linear Models](scikit-learn/generalized-linear-models.md)
    - [1.1.13. Stochastic Gradient Descent - SGD](scikit-learn/stochastic-gradient-descent-sgd.md)
    - [1.1.14. Perceptron](scikit-learn/perceptron.md)
    - [1.1.15. Passive Aggressive Algorithms](scikit-learn/passive-aggressive-algorithms.md)
  ...
  - [1.2. Linear and Quadratic Discriminant Analysis](scikit-learn/linear-and-quadratic-discriminant-analysis.md)
  - [1.3. Kernel ridge regression](scikit-learn/kernel-ridge-regression.md)
...
- [12. Dispatching](https://scikit-learn.org/stable/dispatching.html)
  - [12.1. Array API support (experimental)](https://scikit-learn.org/stable/modules/array_api.html)
    - [12.1.1. Example usage](https://scikit-learn.org/stable/modules/array_api.html#example-usage)
    - [12.1.2. Support for `Array API`\-compatible inputs](https://scikit-learn.org/stable/modules/array_api.html#support-for-array-api-compatible-inputs)
    - [12.1.3. Input and output array type handling](https://scikit-learn.org/stable/modules/array_api.html#input-and-output-array-type-handling)
    - [12.1.4. Common estimator checks](https://scikit-learn.org/stable/modules/array_api.html#common-estimator-checks)
